...
const parse = __nccwpck_require__(718);
const enoent = __nccwpck_require__(958);
...
const resolveCommand = __nccwpck_require__(621);
const escape = __nccwpck_require__(729);
const readShebang = __nccwpck_require__(10);
...
const shebangCommand = __nccwpck_require__(440);
...
const path = __nccwpck_require__(17);
const which = __nccwpck_require__(623);
...
const bufferStream = __nccwpck_require__(644);
...
if (process.platform === 'win32' || global.TESTING_WINDOWS) {
  core = __nccwpck_require__(138)
} else {
  core = __nccwpck_require__(109)
}
...
const shebangRegex = __nccwpck_require__(477);
...
if (!processOk(process)) {
  ...
  var signals = __nccwpck_require__(620)
...
const isexe = __nccwpck_require__(930)
...
var signal_exit = __nccwpck_require__(305);
...
var get_stream = __nccwpck_require__(565);
// EXTERNAL MODULE: ../node_modules/merge-stream/index.js
var merge_stream = __nccwpck_require__(83);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(613);
